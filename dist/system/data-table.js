System.register(['aurelia-framework', 'aurelia-router', 'aurelia-templating'], function (_export) {
  'use strict';

  var bindable, inject, computedFrom, Router, customElement, DataTable;
    ...
    execute: function () {
      DataTable = (function () {
        ...
        _createDecoratedClass(DataTable, [{
          ...
          key: 'columnLabels',
          decorators: [computedFrom('columns')],
          get: function get() {
        ...
        DataTable = inject(Router, Element)(DataTable) || DataTable;
        DataTable = customElement('data-table')(DataTable) || DataTable;
        return DataTable;
      })();
